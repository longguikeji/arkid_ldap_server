...
client.bind('cn=guancy,ou=people, o=d97c8b073da8407a9b232843b52b08f5, dc=longguikeji, dc=com', 'Guancyxx2021**', function (err) {
  if (err) {
  ...
  client.search(`ou=people, o=d97c8b073da8407a9b232843b52b08f5, dc=longguikeji, dc=com`, opts, function (err, res) {
